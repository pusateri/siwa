...
//! Provides verification of identityToken
//! From Apple's docs at https://developer.apple.com/documentation/signinwithapplerestapi/verifying_a_user
...
pub async fn validate(base64_token: String, ignore_expire: bool) -> Result<bool, ValidateError> {
	...
	match decode::<Claims>(str::from_utf8(&token).unwrap(), 
